...
export const defaultBusinessInfo: BusinessInfo = {
  ...
  description: `Example Solutions is a boutique software development company founded and solely operated by Jane Thompson. Based in Amsterdam, the Netherlands, Jane splits her time between a home office and a shared workspace in the city center, where she collaborates directly with clients on occasion. Example Solutions generates an annual revenue of €400,000, with about 60% of income coming from one long-term client, EcoTech Innovations.
